...
import { HomeIcon, PlayIcon, Presentation, Share2 } from "lucide-react";
...
const Navbar = ({ presentationId }: Props) => {
  ...
  return (
    ...
    >
      ...
      <Link href="/presenation/template-market" className="text-lg font-semibold hidden sm:block">
      Presentation Editor</Link>
      <div className="flex items-center gap-4">
        <Button style={{
            backgroundColor: currentTheme.backgroundColor
        }} onClick={handleCopy} variant="outline">
